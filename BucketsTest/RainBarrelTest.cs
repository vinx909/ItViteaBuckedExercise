...
namespace BucketsTest
{
    public class RainBarrelTest
    {
        ...
        {
            //Arrange
            int setToCapacity = 100;
            Container systemUnderTest = new RainBarrel(RainBarrelSize.medium);
        ...
        public void SetContentTest()
        {
            //Arrange
            int contentAmount = 4;
            Container systemUnderTest = new RainBarrel(RainBarrelSize.medium, contentAmount);
            //Act
        ...
        public void SetNegativeContentTest()
        {
            //Arrange
            int contentAmount = -4;
            Action negativeContentTestAction = () => { new RainBarrel(RainBarrelSize.medium, contentAmount); };
            //Act
        ...
        public void FillOverflowedOverflowingActionsChangeFilledCalledTest()
        {
            ...
            for (int i = 0; i < filledCalled.Count; i++)
            {
                ...
                systemUnderTest = new RainBarrel(RainBarrelSize.medium);
                systemUnderTest.Filled += filledDelagate;
                systemUnderTest.Overflowing += overflowingDelagate;
                systemUnderTest.Fill(systemUnderTest.Capacity + 1);
            }
        ...
        public void EmptyTest()
        {
            //Arrange
            int content = 10;
            Container systemUnderTest = new RainBarrel(RainBarrelSize.medium, content);
